      ...
      <div class="container-fluid" id="registerSection">
        ...
        <div class="container">
          ...
          <div class="row pay display_none">
            ...
            <div class="col-sm-12">
              <center><img class="visa" id="checkout" src="img/visa2.png"></center>
            </div>
          </div>
          <br><br>
        </div>
            ...
            $.ajax({ //Process the form using $.ajax()
                ...
                success: function(msg) {
                  if (msg == "success") {
                    ...
                    swal("Возникла ошибка", msg+"Попробуйте еще раз немного позже. Или обратитесь в службу технической поддержке.", "error");
                    infoButtonBool = true;
